...
namespace Eva2DWSInicial.Controllers
{
    public class EvaTchNotasEvaluacionsController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(long id, [Bind("MdUuid,MdFch,IdNotaEvaluacion,CodAlumno,NotaEvaluacion,CodEvaluacion")] EvaTchNotasEvaluacion evaTchNotasEvaluacion)
        {
